...
orderRoutes.get("/getOrders", (req, resp) => {
...
orderRoutes.post("/getOrdersByEmail", (req, resp) => {
...
orderRoutes.post("/getOrderById", (req, resp) => {
...
orderRoutes.post("/createOrder", (req, resp) => {
   let order;
   try {
...
orderRoutes.post("/finishInstallation", (req, resp) => {
   if(req.body["orderId"] == undefined) {
      resp.status(400).
      send(
         {"error": "defined orderID"}
...
orderRoutes.post("/finishShutter", (req, resp) => {
   if(req.body["orderId"] == undefined) {
      resp.status(400).
      send(
         {"error": "defined orderID"}
...
orderRoutes.post("/createInvoiceForOrder", (req, resp) => {
   if(req.body["orderId"] == undefined) {
      resp.status(400).
      send(
         {"error": "defined orderID"}
